 ...
 * cookie
 */
$cfg['blowfish_secret'] = 'ckw3lYF4qrMUnCRbNjl2wb6OMHAbkc0I'; /* YOU MUST FILL IN THIS FOR COOKIE AUTH! */
...
$cfg['Servers'][$i]['password']      = 'Geinshow2019';          // MySQL password (only needed
